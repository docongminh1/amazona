...
function ProductsScreen(props) {
    ...
    return <div className="content content-margined">
        ...
        <div className="product-header">
            <h3>Sản Phẩm</h3>
            <button className="button primary" onClick={() => openModal({})}>Tạo sản phẩm</button>
        </div>
        {modalVisible &&
            <div className="form">
                <form onSubmit={submitHandler} >
                    <ul className="form-container">
                        ...
                        <li>
                            <button type="submit" className="button primary">{id ? "Sửa" : "Tạo"}</button>
                        </li>
                        <li>
                            <button type="button" onClick={() => setModalVisible(false)} className="button secondary">Trở lại</button>
                        </li>
                    </ul>
                </form>
            </div>
